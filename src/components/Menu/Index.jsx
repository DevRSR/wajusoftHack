...
function Index({ isOpen, setOpen, activeMode, onChangeMode}) {

  const [activeId, setActiveId] = useState('main-menu');
  ...
  return (
    <div className=' dark:bg-slate-800 flex flex-col w-12 sm:w-20 h-screen gap-5'>
      <div className=' flex flex-col justify-center items-center gap-1 w-full'>
        <div className="md:hidden block">
          <Hamburger toggled={isOpen} toggle={setOpen}  color={ !activeMode ? '#26282C' : '#fff'} size={15} />
        </div>
        <a aria-label='Open-ways logo' href="/">
          <div id='logo' className='w-6 h-6 md:w-10 md:h-10 rounded-full dark:bg-white'>
            <svg className='w-6 h-6 md:w-10 md:h-10 ' xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
    ...
    <div className=' flex flex-col  w-full h-full '>
      <div className=' flex flex-col w-full h-full gap-4'>
        <button onClick={() => handleClick('main-menu') } id='main-menu' className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path className=' dark:fill-white' d="M7.24 2H5.34C3.15 2 2 3.15 2 5.33V7.23C2 9.41 3.15 10.56 5.33 10.56H7.23C9.41 10.56 10.56 9.41 10.56 7.23V5.33C10.57 3.15 9.42 2 7.24 2Z" fill="#0D062D"/>
            <path className=' dark:fill-white' opacity="0.4" d="M18.6699 2H16.7699C14.5899 2 13.4399 3.15 13.4399 5.33V7.23C13.4399 9.41 14.5899 10.56 16.7699 10.56H18.6699C20.8499 10.56 21.9999 9.41 21.9999 7.23V5.33C21.9999 3.15 20.8499 2 18.6699 2Z" fill="#0D062D"/>
            <path className=' dark:fill-white' d="M18.6699 13.4301H16.7699C14.5899 13.4301 13.4399 14.5801 13.4399 16.7601V18.6601C13.4399 20.8401 14.5899 21.9901 16.7699 21.9901H18.6699C20.8499 21.9901 21.9999 20.8401 21.9999 18.6601V16.7601C21.9999 14.5801 20.8499 13.4301 18.6699 13.4301Z" fill="#0D062D"/>
            <path className=' dark:fill-white' opacity="0.4" d="M7.24 13.4301H5.34C3.15 13.4301 2 14.5801 2 16.7601V18.6601C2 20.8501 3.15 22.0001 5.33 22.0001H7.23C9.41 22.0001 10.56 20.8501 10.56 18.6701V16.7701C10.57 14.5801 9.42 13.4301 7.24 13.4301Z" fill="#0D062D"/>
          </svg>
          <motion.svg 
            animate={{ scaleY: activeId === 'main-menu' ? 1 : 1.5, opacity: activeId === 'main-menu' ? 1 : 0, display: activeId === 'main-menu' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === 'main-menu' ? 'block' : 'hidden'} h-[14px] md:h-[21px] absolute right-[1px] top-[1px]`} 
        ...
        <button onClick={() => handleClick('trends')} id='trends' className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg 
            animate={{ scaleY: activeId === 'trends' ? 1 : 1.5, opacity: activeId === 'trends' ? 1 : 0, display: activeId === 'trends' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === 'trends' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('users') } id='users'  className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg 
            animate={{ scaleY: activeId === 'users' ? 1 : 1.5, opacity: activeId === 'users' ? 1 : 0, display: activeId === 'users' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }}
            className={` ${ activeId === 'users' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('orders') } id='orders'  className=' relative flex justify-center items-center w-full'>
          <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
          ...
          <motion.svg
            animate={{ scaleY: activeId === 'orders' ? 1 : 1.5, opacity: activeId === 'orders' ? 1 : 0, display: activeId === 'orders' ? 'block' : 'none'}}
            transition={{ duration: 0.3, delay: 0.1 }} 
            className={` ${ activeId === 'orders' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
            <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
          </motion.svg>
        </button>
        <button onClick={ () => handleClick('settings') } id='settings'  className=' relative flex justify-center items-center w-full'>
        <svg className=' w-4 h-4 md:w-6 md:h-6 hover:scale-105' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <motion.svg
             animate={{ scaleY: activeId === 'settings' ? 1 : 1.5, opacity: activeId === 'settings' ? 1 : 0, display: activeId === 'settings' ? 'block' : 'none'}} 
             transition={{ duration: 0.3, delay: 0.1 }}
             className={` ${ activeId === 'settings' ? 'block' : 'hidden'} h-[14px] md:h-[21px]  absolute right-[1px] top-[1px]`} xmlns="http://www.w3.org/2000/svg" width="3" height="21" viewBox="0 0 3 21" fill="none">
                <path className=' dark:fill-white' d="M6.53467e-06 3.02509C7.11773e-06 1.42129 1.40951 0.182713 3 0.388889V21C1.34315 21 4.88293e-07 19.6569 1.09063e-06 18L6.53467e-06 3.02509Z" fill="#0D062D"/>
            </motion.svg>
        </button>


        <label  htmlFor="theme" className=' relative flex justify-center items-center w-full'>
          <input 
            tabIndex={-1}
            type="checkbox" 
            name="theme"  
            className=' absolute opacity-0 z-50 w-full h-full cursor-pointer'
            onChange={onChangeMode} 
          />
            <div tabIndex={0} onKeyDown={ handleKeyDown } className="flex flex-col items-center gap-4 w-auto h-auto p-1 md:p-2 dark:bg-slate-700 bg-white rounded-full">
              <div className={` flex justify-center items-center w-full h-full ${ !activeMode ? 'rounded-full p-1 md:p-2 bg-custom-green' : ''}`}>
                <svg className={` ${ !activeMode ? 'w-3 h-3 md:w-[18px] md:h-[18px]' : 'w-5 h-5 md:w-[30px] md:h-[30px]' } `} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
              ...
              <div className={` flex justify-center items-center w-full ${ activeMode ? 'rounded-full p-1 md:p-2 bg-custom-green' : ''} `}>
                <svg className={`${ activeMode ? 'w-3 h-3 md:w-[18px] md:h-[18px]' : 'w-5 h-5 md:w-[30px] md:h-[30px]' }`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" fill="none">
        ...
        <button onMouseOver={ () => handleHover('back') } onMouseOut={handleMouseOut}  className=' relative justify-self-end flex justify-center items-center w-full'>
            ...
            {hoverState === 'back' && 
               <motion.p 
                ...
                className=' absolute -bottom-4 dark:text-white text-xs'
              >
                back
              </motion.p>}
        </button>
